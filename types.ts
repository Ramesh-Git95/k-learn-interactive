export type Section = 'dashboard' | 'hangul' | 'vocabulary' | 'grammar' | 'phrases' | 'culture' | 'quiz' | 'conversation' | 'bookmarks' | 'srs' | 'profile' | 'cookie-demo' | 'topik' | 'honorifics' | 'culture-cards' | 'typing' | 'kdrama' | 'kpop';
